...
/bin/bash -c  "cd /exp/sbnd/app/users/gputnam/Ar23-knobs && source nusyst_env.sh && UpdateReweight -c nusystematics/fcl/Ar23_new_knobs.ParamHeader.fcl -i $TEMPFILE -o $2" >&1
#ls -ltr /tmp/
rm $TEMPFILE
#ls -ltr /tmp/
#echo WASSUPNATE
