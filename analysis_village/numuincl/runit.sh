...
python /exp/sbnd/app/users/brindenc/develop/cafpyana/analysis_village/numuincl/runit.py -y /exp/sbnd/app/users/brindenc/develop/cafpyana/analysis_village/numuincl/yamls/det_var/wiremod.yaml
